        ...
        <div class="col-xl-5 col-lg-7 col-md-9 col-11 bg-gradient-orange rounded-4 shadow" style="padding: 1px;">
            <div class="bg-white rounded-4 p-3">
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                    <div>
                        <h2 class="fw-bold text-orange mb-0"><i class="fa-solid fa-user-plus"></i> Nuevo Usuario</h2>
                    ...
                    <form action="{{ route("teachers.create") }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="role" class="form-control"
                                placeholder="Ej. Profesor, Profesora, Administrativo" value="{{ old('role') }}" required>
                        </div>
