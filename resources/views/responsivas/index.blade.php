        ...
        <div class="col-xxl-8 col-xl-10 col-lg-11 col-12">
                ...
                <form method="GET" class="col-lg-6 col-12 mb-lg-0 mb-3">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control"
                            placeholder="&#x1F50E;&#xFE0E; Buscar por folio, apellido del usuario o numero de serie"
            ...
            <div class="col-12 mt-4">
                <table class="col-12 w-100 p-3 rounded-2 bg-white shadow">
                    <!-- Cabecera -->
                    <thead>
                        <tr class="col-12 row mx-auto text-white py-3 rounded-top-2"
                            style="background: linear-gradient(135deg,rgba(166, 63, 255, 0.8), rgba(136, 13, 224, 1));">
                        ...
                        @foreach ($responsivas as $r)
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu text-center">
                                            <li class="d-flex flex-wrap p-2 justify-content-around">
                                                <!-- Imprimir -->
                                                <a href="{{ route('responsivas.pdf', $r) }}" target="_blank"
                                                    class="text-decoration-none"" data-bs-toggle=" tooltip"
                                                    data-bs-placement="top" title="Imprimir la responsiva">
                                                    <i class="fa-solid fa-print"></i>
                                                </a>
                                                <!-- Edicion -->
                                                @if ($r->status === 'Activa')
                                                    <a href="{{ route('responsivas.edit', $r) }}"
                                                        class="text-warning"" data-bs-toggle=" tooltip" data-bs-placement="top"
                                                        title="Editar la responsiva">
                                                        <i class="fa-solid fa-pen"></i>
                                                    </a>
                                                @endif
                                                <!-- Ver -->
                                                <a href="{{ route('responsivas.show', $r) }}"
                                                    class="text-success"" data-bs-toggle=" tooltip" data-bs-placement="top"
                                                    title="Ver la responsiva">
                                            ...
                                            <li class="d-flex flex-wrap p-2 justify-content-around">
                                                ...
                                                <a href="{{ route('responsivas.history', $r) }}"
                                                    class="text-decoration-none"" data-bs-toggle=" tooltip"
                                                    data-bs-placement="top" title="Ver historial de la responsiva">
                                                    <i class="fa-solid fa-clock-rotate-left" style="color: #A52EFB;"></i>
                                                </a>
                                                <!-- Devolver -->
                                                @if ($r->status === 'Activa')
                                                    <button style="background: none; border: none;" data-bs-toggle="modal"
                                                        data-bs-target="#returnModal{{ $r->id }}">
                                                        <i class="fa-solid fa-arrow-rotate-left" style="color: #F54900;"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Devolver dispositivo"></i>
                                                    </button>
                                                @endif
                                                <!-- Correo -->
                                                @if ($r->status === 'Activa' && $r->teacher->email)
                                                    ...
                                                    <a href="{{ $gmailUrl }}" target="_blank"
                                                        class="text-decoration-none"" data-bs-toggle=" tooltip"
                                                        data-bs-placement="top" title="Enviar correo con Gmail">
                                                ...
                                                @if ($r->status === 'Regresado')
                                                    <button style="background: none; border: none;" data-bs-toggle="modal"
                                                        ...
                                                        <i class="fa-regular fa-trash-can text-danger" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Eliminar Responsiva"></i>
                                                    </button>
                                                @endif
                                            </li>
                                        </ul>
                            ...
                            <div class="modal fade" id="returnModal{{ $r->id }}">
                                <div class="modal-dialog">
                                    <form method="POST" action="{{ route('responsivas.return', $r) }}">
                                        @csrf
                                        @method('PUT')
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{ route('responsivas.destroy', $r) }}">
                                                @csrf
                                                @method('DELETE')
