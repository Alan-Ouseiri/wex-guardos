        ...
        <div class="col-xl-5 col-lg-7 col-md-9 col-11 bg-gradient-teal rounded-4 shadow" style="padding: 1px;">
            <div class="bg-white rounded-4 p-3">
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                    <div>
                        <h2 class="fw-bold text-teal mb-0"><i class="fa-solid fa-mobile-screen-button"></i> Nuevo
                            Dispositivo</h2>
                        <span class="text-secondary" style="font-size: 14px;">Completa los datos para crear un nuevo
                            Dispositivo</span>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('devices.create') }}">
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="fa-solid fa-laptop text-teal"></i>
                                Tipo</label>
                            <input type="text" name="type" class="form-control" placeholder="Ej. Macbook, iPad, iMac"
                                value="{{ old('type') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="fa-regular fa-copyright text-teal"></i>
                                Marca</label>
                            <input type="text" name="brand" class="form-control" placeholder="Ej. Apple, Lenovo, MSI"
                                value="{{ old('brand') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="fa-solid fa-mobile text-teal"></i>
                                Modelo</label>
                            <input type="text" name="model" class="form-control" placeholder="Ej. 5 Gen, 8, Air 11"
                                value="{{ old('model') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="fa-solid fa-barcode text-teal"></i> Número de
                                Serie</label>
                            <input type="text" name="serial_number" class="form-control" placeholder="xxxxxxxxxxxx"
